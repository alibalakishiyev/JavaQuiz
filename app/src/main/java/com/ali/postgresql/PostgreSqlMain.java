...
public class PostgreSqlMain extends AppCompatActivity implements AlgoListener {
    ...
    OnBackPressedCallback callback = new OnBackPressedCallback(true) {
        ...
        public void handleOnBackPressed() {
            MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(PostgreSqlMain.this);
            ...
            materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int i) {
                    startActivity(new Intent(PostgreSqlMain.this , MainActivity.class));
                    finish();
                }
            });
