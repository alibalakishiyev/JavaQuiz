...
public class SplashPostgreSqActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(() -> {
            startActivity(new Intent(SplashPostgreSqActivity.this, PostgreSqlMain.class));
            finish();
        }, 5000); // 4 saniyə
    }

    private void playVideo() {
        Uri videoPath = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.postgresql);
