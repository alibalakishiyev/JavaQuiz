...
public class SqlQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sql_quiz);
        ...
        aans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                nextButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!isAnswered){
                            Toast.makeText(SqlQuiz.this, "Cavab seçin", Toast.LENGTH_SHORT).show();
                        }else {
                            isAnswered = false;
                            if (currentQuestions < quesitionsItems.size() - 1) {
                                ...
                                Intent intent = new Intent(SqlQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        addQuestionsFromJsonArray("postgresql_questions1");
        addQuestionsFromJsonArray("postgresql_questions2");
        addQuestionsFromJsonArray("postgresql_questions3");
        addQuestionsFromJsonArray("postgresql_questions4");
        addQuestionsFromJsonArray("postgresql_questions5");


    }

    private void addQuestionsFromJsonArray(String arrayName) {
        String jsonquiz = loadJsonFromAsset("sql_query/SqlQuestions.json");
        try {
    ...
    OnBackPressedCallback callback = new OnBackPressedCallback(true) {
        ...
        public void handleOnBackPressed() {
            MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(SqlQuiz.this);
            ...
            materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int i) {
                    startActivity(new Intent(SqlQuiz.this , PostgreSqlMain.class));
                    finish();
                }
            });
