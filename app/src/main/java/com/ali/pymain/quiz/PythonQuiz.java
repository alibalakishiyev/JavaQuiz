...
public class PythonQuiz extends AppCompatActivity {
    ...
    private void disableButtonsAndShowNext() {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isAnswered) {
                    Toast.makeText(PythonQuiz.this, "Cavab seçin", Toast.LENGTH_SHORT).show();
                } else {
                    isAnswered = false;
    ...
    private void goToResult() {
        Intent intent = new Intent(PythonQuiz.this, ResultActivity.class);
    ...
    OnBackPressedCallback callback = new OnBackPressedCallback(true) {
        ...
        public void handleOnBackPressed() {
            MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(PythonQuiz.this);
            ...
            materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int i) {
                    startActivity(new Intent(PythonQuiz.this, PythonMain.class));
                    finish();
                }
            });
